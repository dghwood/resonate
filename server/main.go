...
import (
	...
	"github.com/dghwood/resonate/server/api"
	cacheService "github.com/dghwood/resonate/server/services/cachestore/cloudstorage"
	datastoreService "github.com/dghwood/resonate/server/services/datastore/firestore"
	fetchService "github.com/dghwood/resonate/server/services/fetch"
	imagestoreService "github.com/dghwood/resonate/server/services/imagestore"
	searchService "github.com/dghwood/resonate/server/services/search"
	"github.com/dghwood/resonate/server/services/secrets"

	"github.com/dghwood/resonate/server/api/auth"
	"github.com/dghwood/resonate/server/api/feed"
	"github.com/dghwood/resonate/server/api/find"
	"github.com/dghwood/resonate/server/api/follows"
	"github.com/dghwood/resonate/server/api/listens"
	"github.com/dghwood/resonate/server/api/podcast"
	"github.com/dghwood/resonate/server/api/search"
	"github.com/dghwood/resonate/server/api/subscribe"
	"github.com/dghwood/resonate/server/api/upload"
	"github.com/dghwood/resonate/server/api/users"
