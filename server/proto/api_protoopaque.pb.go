...
type SyncSubscriptionsMessage struct {
	state               protoimpl.MessageState             `protogen:"opaque.v1"`
	xxx_hidden_Request  *SyncSubscriptionsMessage_Request  `protobuf:"bytes,1,opt,name=request,proto3"`
	xxx_hidden_Response *SyncSubscriptionsMessage_Response `protobuf:"bytes,2,opt,name=response,proto3"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
