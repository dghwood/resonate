...
const file_proto_api_proto_rawDesc = "" +
	...
	"\bResponse\x12?\n" +
	"\rresponse_info\x18\x01 \x01(\v2\x1a.resonate.api.ResponseInfoR\fresponseInfo\x12E\n" +
	"\fsubscription\x18\x02 \x01(\v2!.resonate.UserSubscriptionMessageR\fsubscription\"\x8e\x03\n" +
	"\x17ListSubscriptionMessage\x12G\n" +
	"\arequest\x18\x01 \x01(\v2-.resonate.api.ListSubscriptionMessage.RequestR\arequest\x12J\n" +
	"\bresponse\x18\x02 \x01(\v2..resonate.api.ListSubscriptionMessage.ResponseR\bresponse\x1aG\n" +
	"\aRequest\x12<\n" +
	"\frequest_info\x18\x01 \x01(\v2\x19.resonate.api.RequestInfoR\vrequestInfo\x1a\x94\x01\n" +
	"\bResponse\x12?\n" +
	...
	"\x06listen\x18\x02 \x01(\v2\x1b.resonate.UserListenMessageR\x06listen\"\xa0\x03\n" +
...
var file_proto_api_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_proto_api_proto_goTypes = []any{
	...
	(*GetFeedMessage)(nil),                      // 16: resonate.api.GetFeedMessage
	(*RefreshAuthMessage_Request)(nil),          // 17: resonate.api.RefreshAuthMessage.Request
	(*RefreshAuthMessage_Response)(nil),         // 18: resonate.api.RefreshAuthMessage.Response
	(*LoginRequestMessage_Request)(nil),         // 19: resonate.api.LoginRequestMessage.Request
	(*LoginRequestMessage_Response)(nil),        // 20: resonate.api.LoginRequestMessage.Response
	(*LoginUserMessage_Request)(nil),            // 21: resonate.api.LoginUserMessage.Request
	(*LoginUserMessage_Response)(nil),           // 22: resonate.api.LoginUserMessage.Response
	(*CreateUserMessage_Request)(nil),           // 23: resonate.api.CreateUserMessage.Request
	(*CreateUserMessage_Response)(nil),          // 24: resonate.api.CreateUserMessage.Response
	(*GetUserMessage_Request)(nil),              // 25: resonate.api.GetUserMessage.Request
	(*GetUserMessage_Response)(nil),             // 26: resonate.api.GetUserMessage.Response
	(*UpdateUserMessage_Request)(nil),           // 27: resonate.api.UpdateUserMessage.Request
	(*UpdateUserMessage_Response)(nil),          // 28: resonate.api.UpdateUserMessage.Response
	(*SearchMessage_Request)(nil),               // 29: resonate.api.SearchMessage.Request
	(*SearchMessage_Response)(nil),              // 30: resonate.api.SearchMessage.Response
	(*GetPodcastMessage_Request)(nil),           // 31: resonate.api.GetPodcastMessage.Request
	(*GetPodcastMessage_Response)(nil),          // 32: resonate.api.GetPodcastMessage.Response
	(*ListPodcastEpisodesMessage_Request)(nil),  // 33: resonate.api.ListPodcastEpisodesMessage.Request
	(*ListPodcastEpisodesMessage_Response)(nil), // 34: resonate.api.ListPodcastEpisodesMessage.Response
	(*GetEpisodeMessage_Request)(nil),           // 35: resonate.api.GetEpisodeMessage.Request
	(*GetEpisodeMessage_Response)(nil),          // 36: resonate.api.GetEpisodeMessage.Response
	(*AddSubscriptionMessage_Request)(nil),      // 37: resonate.api.AddSubscriptionMessage.Request
	(*AddSubscriptionMessage_Response)(nil),     // 38: resonate.api.AddSubscriptionMessage.Response
	(*RemoveSubscriptionMessage_Request)(nil),   // 39: resonate.api.RemoveSubscriptionMessage.Request
	(*RemoveSubscriptionMessage_Response)(nil),  // 40: resonate.api.RemoveSubscriptionMessage.Response
	(*ListSubscriptionMessage_Request)(nil),     // 41: resonate.api.ListSubscriptionMessage.Request
	(*ListSubscriptionMessage_Response)(nil),    // 42: resonate.api.ListSubscriptionMessage.Response
	(*AddListenMessage_Request)(nil),            // 43: resonate.api.AddListenMessage.Request
	(*AddListenMessage_Response)(nil),           // 44: resonate.api.AddListenMessage.Response
	(*GetFeedMessage_Request)(nil),              // 45: resonate.api.GetFeedMessage.Request
	(*GetFeedMessage_Response)(nil),             // 46: resonate.api.GetFeedMessage.Response
	(*TokenMessage)(nil),                        // 47: resonate.TokenMessage
	(*UserMessage)(nil),                         // 48: resonate.UserMessage
	(*SearchResultsMessage)(nil),                // 49: resonate.SearchResultsMessage
	(*PodcastMessage)(nil),                      // 50: resonate.PodcastMessage
	(*EpisodeMessage)(nil),                      // 51: resonate.EpisodeMessage
	(*UserSubscriptionMessage)(nil),             // 52: resonate.UserSubscriptionMessage
	(*UserListenMessage)(nil),                   // 53: resonate.UserListenMessage
	(*UserFeedMessage)(nil),                     // 54: resonate.UserFeedMessage
}
var file_proto_api_proto_depIdxs = []int32{
	47, // 0: resonate.api.RequestInfo.access_token:type_name -> resonate.TokenMessage
	17, // 1: resonate.api.RefreshAuthMessage.request:type_name -> resonate.api.RefreshAuthMessage.Request
	18, // 2: resonate.api.RefreshAuthMessage.response:type_name -> resonate.api.RefreshAuthMessage.Response
	19, // 3: resonate.api.LoginRequestMessage.request:type_name -> resonate.api.LoginRequestMessage.Request
	20, // 4: resonate.api.LoginRequestMessage.response:type_name -> resonate.api.LoginRequestMessage.Response
	21, // 5: resonate.api.LoginUserMessage.request:type_name -> resonate.api.LoginUserMessage.Request
	22, // 6: resonate.api.LoginUserMessage.response:type_name -> resonate.api.LoginUserMessage.Response
	23, // 7: resonate.api.CreateUserMessage.request:type_name -> resonate.api.CreateUserMessage.Request
	24, // 8: resonate.api.CreateUserMessage.response:type_name -> resonate.api.CreateUserMessage.Response
	25, // 9: resonate.api.GetUserMessage.request:type_name -> resonate.api.GetUserMessage.Request
	26, // 10: resonate.api.GetUserMessage.response:type_name -> resonate.api.GetUserMessage.Response
	27, // 11: resonate.api.UpdateUserMessage.request:type_name -> resonate.api.UpdateUserMessage.Request
	28, // 12: resonate.api.UpdateUserMessage.response:type_name -> resonate.api.UpdateUserMessage.Response
	29, // 13: resonate.api.SearchMessage.request:type_name -> resonate.api.SearchMessage.Request
	30, // 14: resonate.api.SearchMessage.response:type_name -> resonate.api.SearchMessage.Response
	31, // 15: resonate.api.GetPodcastMessage.request:type_name -> resonate.api.GetPodcastMessage.Request
	32, // 16: resonate.api.GetPodcastMessage.response:type_name -> resonate.api.GetPodcastMessage.Response
	33, // 17: resonate.api.ListPodcastEpisodesMessage.request:type_name -> resonate.api.ListPodcastEpisodesMessage.Request
	34, // 18: resonate.api.ListPodcastEpisodesMessage.response:type_name -> resonate.api.ListPodcastEpisodesMessage.Response
	35, // 19: resonate.api.GetEpisodeMessage.request:type_name -> resonate.api.GetEpisodeMessage.Request
	36, // 20: resonate.api.GetEpisodeMessage.response:type_name -> resonate.api.GetEpisodeMessage.Response
	37, // 21: resonate.api.AddSubscriptionMessage.request:type_name -> resonate.api.AddSubscriptionMessage.Request
	38, // 22: resonate.api.AddSubscriptionMessage.response:type_name -> resonate.api.AddSubscriptionMessage.Response
	39, // 23: resonate.api.RemoveSubscriptionMessage.request:type_name -> resonate.api.RemoveSubscriptionMessage.Request
	40, // 24: resonate.api.RemoveSubscriptionMessage.response:type_name -> resonate.api.RemoveSubscriptionMessage.Response
	41, // 25: resonate.api.ListSubscriptionMessage.request:type_name -> resonate.api.ListSubscriptionMessage.Request
	42, // 26: resonate.api.ListSubscriptionMessage.response:type_name -> resonate.api.ListSubscriptionMessage.Response
	43, // 27: resonate.api.AddListenMessage.request:type_name -> resonate.api.AddListenMessage.Request
	44, // 28: resonate.api.AddListenMessage.response:type_name -> resonate.api.AddListenMessage.Response
	45, // 29: resonate.api.GetFeedMessage.request:type_name -> resonate.api.GetFeedMessage.Request
	46, // 30: resonate.api.GetFeedMessage.reponse:type_name -> resonate.api.GetFeedMessage.Response
	1,  // 31: resonate.api.RefreshAuthMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	47, // 32: resonate.api.RefreshAuthMessage.Request.refresh_token:type_name -> resonate.TokenMessage
	0,  // 33: resonate.api.RefreshAuthMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	47, // 34: resonate.api.RefreshAuthMessage.Response.access_token:type_name -> resonate.TokenMessage
	1,  // 35: resonate.api.LoginRequestMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 36: resonate.api.LoginRequestMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	1,  // 37: resonate.api.LoginUserMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 38: resonate.api.LoginUserMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	47, // 39: resonate.api.LoginUserMessage.Response.access_token:type_name -> resonate.TokenMessage
	47, // 40: resonate.api.LoginUserMessage.Response.refresh_token:type_name -> resonate.TokenMessage
	48, // 41: resonate.api.LoginUserMessage.Response.user:type_name -> resonate.UserMessage
	1,  // 42: resonate.api.CreateUserMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	48, // 43: resonate.api.CreateUserMessage.Request.user:type_name -> resonate.UserMessage
	0,  // 44: resonate.api.CreateUserMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	48, // 45: resonate.api.CreateUserMessage.Response.user:type_name -> resonate.UserMessage
	1,  // 46: resonate.api.GetUserMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 47: resonate.api.GetUserMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	48, // 48: resonate.api.GetUserMessage.Response.user:type_name -> resonate.UserMessage
	1,  // 49: resonate.api.UpdateUserMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	48, // 50: resonate.api.UpdateUserMessage.Request.user:type_name -> resonate.UserMessage
	0,  // 51: resonate.api.UpdateUserMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	48, // 52: resonate.api.UpdateUserMessage.Response.user:type_name -> resonate.UserMessage
	1,  // 53: resonate.api.SearchMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 54: resonate.api.SearchMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	49, // 55: resonate.api.SearchMessage.Response.search_results:type_name -> resonate.SearchResultsMessage
	1,  // 56: resonate.api.GetPodcastMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 57: resonate.api.GetPodcastMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	50, // 58: resonate.api.GetPodcastMessage.Response.podcast:type_name -> resonate.PodcastMessage
	1,  // 59: resonate.api.ListPodcastEpisodesMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 60: resonate.api.ListPodcastEpisodesMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	51, // 61: resonate.api.ListPodcastEpisodesMessage.Response.episodes:type_name -> resonate.EpisodeMessage
	50, // 62: resonate.api.ListPodcastEpisodesMessage.Response.podcast:type_name -> resonate.PodcastMessage
	1,  // 63: resonate.api.GetEpisodeMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 64: resonate.api.GetEpisodeMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	51, // 65: resonate.api.GetEpisodeMessage.Response.episode:type_name -> resonate.EpisodeMessage
	1,  // 66: resonate.api.AddSubscriptionMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	52, // 67: resonate.api.AddSubscriptionMessage.Request.subscription:type_name -> resonate.UserSubscriptionMessage
	0,  // 68: resonate.api.AddSubscriptionMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	52, // 69: resonate.api.AddSubscriptionMessage.Response.subscription:type_name -> resonate.UserSubscriptionMessage
	1,  // 70: resonate.api.RemoveSubscriptionMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	52, // 71: resonate.api.RemoveSubscriptionMessage.Request.subscription:type_name -> resonate.UserSubscriptionMessage
	0,  // 72: resonate.api.RemoveSubscriptionMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	52, // 73: resonate.api.RemoveSubscriptionMessage.Response.subscription:type_name -> resonate.UserSubscriptionMessage
	1,  // 74: resonate.api.ListSubscriptionMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 75: resonate.api.ListSubscriptionMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	52, // 76: resonate.api.ListSubscriptionMessage.Response.subscriptions:type_name -> resonate.UserSubscriptionMessage
	1,  // 77: resonate.api.AddListenMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	53, // 78: resonate.api.AddListenMessage.Request.listen:type_name -> resonate.UserListenMessage
	0,  // 79: resonate.api.AddListenMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	53, // 80: resonate.api.AddListenMessage.Response.listen:type_name -> resonate.UserListenMessage
	1,  // 81: resonate.api.GetFeedMessage.Request.request_info:type_name -> resonate.api.RequestInfo
	0,  // 82: resonate.api.GetFeedMessage.Response.response_info:type_name -> resonate.api.ResponseInfo
	54, // 83: resonate.api.GetFeedMessage.Response.feed:type_name -> resonate.UserFeedMessage
