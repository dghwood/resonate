...
type PodcastMessage struct {
	...
	NumSubscriptions   int64 `protobuf:"varint,11,opt,name=num_subscriptions,json=numSubscriptions,proto3" json:"num_subscriptions,omitempty"`
	NumListens         int64 `protobuf:"varint,12,opt,name=num_listens,json=numListens,proto3" json:"num_listens,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (b0 PodcastMessage_builder) Build() *PodcastMessage {
	...
	x.NumSubscriptions = b.NumSubscriptions
	x.NumListens = b.NumListens
	return m0
}
...
type EpisodeMessage struct {
	...
	NumListens       int64                   `protobuf:"varint,13,opt,name=num_listens,json=numListens,proto3" json:"num_listens,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type UserMessage struct {
	...
	NumFollowing  int64 `protobuf:"varint,12,opt,name=num_following,json=numFollowing,proto3" json:"num_following,omitempty"`
	NumListens    int64 `protobuf:"varint,13,opt,name=num_listens,json=numListens,proto3" json:"num_listens,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PublicUserMessage struct {
	...
	NumFollowers  int64                  `protobuf:"varint,4,opt,name=num_followers,json=numFollowers,proto3" json:"num_followers,omitempty"`
	NumFollowing  int64                  `protobuf:"varint,5,opt,name=num_following,json=numFollowing,proto3" json:"num_following,omitempty"`
	NumListens    int64                  `protobuf:"varint,6,opt,name=num_listens,json=numListens,proto3" json:"num_listens,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
