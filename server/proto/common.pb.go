...
const (
	ClientPlatform_CLIENT_PLATFORM_UNKNOWN ClientPlatform = 0
	ClientPlatform_CLIENT_PLATFORM_ANDROID ClientPlatform = 1
	ClientPlatform_CLIENT_PLATFORM_IOS     ClientPlatform = 2
	ClientPlatform_CLIENT_PLATFORM_WEB     ClientPlatform = 3
)

// Enum value maps for ClientPlatform.
var (
	ClientPlatform_name = map[int32]string{
		0: "CLIENT_PLATFORM_UNKNOWN",
		1: "CLIENT_PLATFORM_ANDROID",
		2: "CLIENT_PLATFORM_IOS",
		3: "CLIENT_PLATFORM_WEB",
	}
	ClientPlatform_value = map[string]int32{
		"CLIENT_PLATFORM_UNKNOWN": 0,
		"CLIENT_PLATFORM_ANDROID": 1,
		"CLIENT_PLATFORM_IOS":     2,
		"CLIENT_PLATFORM_WEB":     3,
	}
)
...
type UserListenMessage struct {
	...
	PublicUser      *PublicUserMessage      `protobuf:"bytes,9,opt,name=public_user,json=publicUser,proto3" json:"public_user,omitempty"` // this is optional, used for feed items
	Metadata        *StorageMetadataMessage `protobuf:"bytes,8,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type UserFeedItemEpisodeMessage struct {
	...
	UserListens   []*UserListenMessage `protobuf:"bytes,2,rep,name=user_listens,json=userListens,proto3" json:"user_listens,omitempty"`
	FeedItemType  FeedItemType         `protobuf:"varint,3,opt,name=feed_item_type,json=feedItemType,proto3,enum=resonate.FeedItemType" json:"feed_item_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
