...
type Playlist2Message struct {
	...
	xxx_hidden_Id           string                  `protobuf:"bytes,1,opt,name=id,proto3"`
	xxx_hidden_UserId       string                  `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3"`
	xxx_hidden_EpisodeIndex int64                   `protobuf:"varint,3,opt,name=episode_index,json=episodeIndex,proto3"`
	xxx_hidden_EpisodeIds   []string                `protobuf:"bytes,4,rep,name=episode_ids,json=episodeIds,proto3"`
	xxx_hidden_Metadata     *StorageMetadataMessage `protobuf:"bytes,5,opt,name=metadata,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Playlist2Message) GetEpisodeIndex() int64 {
	if x != nil {
		return x.xxx_hidden_EpisodeIndex
	}
	return 0
}
...
func (b0 Playlist2Message_builder) Build() *Playlist2Message {
	...
	x.xxx_hidden_Id = b.Id
	x.xxx_hidden_UserId = b.UserId
	x.xxx_hidden_EpisodeIndex = b.EpisodeIndex
